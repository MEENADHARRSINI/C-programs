...
#include<iostream>
using namespace std;
int fnread1(int *pinum1,int *pinum2,int *pinum3);
float fnread2(float *pfnum1,float *pfnum2,float *pfnum3);
long fnread3(long *plnum1,long *plnum2,long *plnum3);
short fnread4(short *psnum1,short *psnum2,short *psnum3);
double fnread5(double *pdnum1,double *pdnum2,double *pdnum3);
...
int fndisplay1(int bigint);
float fndisplay2(float bigfloat);
long fndisplay3(long biglong);
short fndisplay4(short bigshort);
double fndisplay5(double bigdouble);
main()
{
	...
	fnread1(&inum1,&inum2,&inum3);
	fnread2(&fnum1,&fnum2,&fnum3);
	fnread3(&lnum1,&lnum2,&lnum3);
	fnread4(&snum1,&snum2,&snum3);
	fnread5(&dnum1,&dnum2,&dnum3);
